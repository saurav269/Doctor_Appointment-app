                ...
                <div className=" flex p-4 text-yellow-800 bg-yellow-50 rounded-lg">
                  ...
                  <span className="sr-only">Info</span>
                    <div className=" ml-3 text-sm font-medium">
                      To get approval please complete your profile. We&apos;ll review manually nd approve within 3 days
                    </div>
                </div>
              )}
              ...
              <div className="mt-8">
                {(tab === 'overview' && <div>
                  <div className=" flex items-center gap-4 mb-10">
                    <figure className=" max-w-[200px] max-h-[200]"><img src={data?.photo} alt='' className=" w-full" /></figure>
                    ...
                    <div>
                      ...
                      <h3 className="text-[22px] leading-9 font-bold text-headingColor mt-3">Jhinuk</h3>
