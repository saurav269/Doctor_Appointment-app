...
import doctorImg from "../../assets/images/doc2.jpg";
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text__para text-[14px] leading-5 lg:text-[15px] lg:max-w-[390px]">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iste
                  sequi deleniti quidem accusantium aspernatur eos odio sit
                  itaque dicta inventore illum, magnam ipsam! Quasi minus
                  quaerat eos porro optio! Magni!
                </p>
              </div>
            </div>
